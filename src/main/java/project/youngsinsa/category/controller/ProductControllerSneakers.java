...
@Controller
@RequestMapping("/hhhh/category/sneakers")
public class ProductControllerSneakers {
    ...
    public ProductControllerSneakers(CategoryServiceImp categoryServiceImp
    ...
    public ModelAndView likeUp(HttpServletRequest request){
        String num = request.getParameter("modelNum");
        String url ="redirect:/hhhh/category/sneakers/Num?modelNum="+num;
