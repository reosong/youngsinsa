...
@Controller
@RequestMapping("/hhhh/category/jewelry")
public class ProductControllerJewelry {
    ...
    public ProductControllerJewelry(CategoryServiceImp categoryServiceImp
    ...
    public ModelAndView likeUp(HttpServletRequest request){
        String num = request.getParameter("modelNum");
        String url ="redirect:/hhhh/category/jewelry/Num?modelNum="+num;
