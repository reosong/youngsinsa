...
@Controller
@RequestMapping("/hhhh/category/sunglass")
public class ProductControllerSunglass {
    ...
    public ProductControllerSunglass(CategoryServiceImp categoryServiceImp
    ...
    public ModelAndView likeUp(HttpServletRequest request){
        String num = request.getParameter("modelNum");
        String url ="redirect:/hhhh/category/sunglass/Num?modelNum="+num;
